            ...
            <header className="bg-blue-900 relative">
                ...
                <div className="relative bg-blue-300/80">
                    ...
                    <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                        ...
                        {/* Title */}
                        <h1 className="text-2xl font-bold text-black"><Link to="/">Healthcare</Link></h1>
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="hidden md:flex space-x-2">
                                <Link to="/signin" className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition">Login</Link>
                                <Link to="/Register" className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition">Signup</Link>
                            </div>
                    ...
                    {/* Mobile Menu */}
                    <div ref={menuRef} className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden bg-blue-100/90`}>
